...
export const EU_ALLERGENS = [
  ...
  'Molluscs', 'Mustard', 'Tree Nuts', 'Peanuts', 'Sesame', 'Soya', 'Sulphur Dioxide',
] as const

export type EuAllergen = typeof EU_ALLERGENS[number]

// Colour per allergen for badges — consistent across all pages
export const ALLERGEN_COLORS: Record<EuAllergen, string> = {
...
export const SESSION_ROLE_IDS_KEY    = 'pelikn_staff_role_ids'
...
export const DEVICE_VENUES_KEY       = 'pelikn_device_venues'  // [{id,slug,name}] — venues this device has added
...
export const EXPLAINED_EXCEEDANCE_REASONS = ['delivery', 'defrost', 'service_access'] as const
