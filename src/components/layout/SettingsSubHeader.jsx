...
export default function SettingsSubHeader({ title, onBack, backLabel = 'Settings' }) {
  return (
    <div className="sticky top-0 z-10 bg-surface/90 backdrop-blur-xl backdrop-saturate-[180%] border-b border-charcoal/10 flex items-center justify-between py-[10px]">
      <button
        onClick={onBack}
