...
export default function StaffPage() {
  ...
  return (
    <div className="pb-24 max-w-[480px] md:max-w-2xl lg:max-w-3xl flex flex-col gap-3">
      {!detailId && (
        <div className="flex items-center justify-between gap-3">
          <div>
            <h1 className="text-[24px] min-[420px]:text-[26px] leading-tight font-bold tracking-tight text-ink dark:text-white">Staff</h1>
