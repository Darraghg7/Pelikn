  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="px-4 pb-24 max-w-[480px] mx-auto">
        ...
        <div className="font-mono text-[10.5px] font-semibold tracking-[0.08em] uppercase text-charcoal/50 pt-[14px] pb-[7px] px-0.5">Attendance alerts</div>
        ...
        <div className="font-mono text-[10.5px] font-semibold tracking-[0.08em] uppercase text-charcoal/50 pt-[14px] pb-[7px] px-0.5">Push notification preferences</div>
