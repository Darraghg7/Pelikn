...
export default function NotificationsPanel({ session, toast, settings }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      {/* Push notifications */}
      <div>
        <p className="text-sm font-medium text-charcoal dark:text-white mb-1">Push Notifications</p>
        ...
        {!supported ? (
          <p className="text-xs text-charcoal/35 dark:text-white/30 italic">Push notifications are not supported in this browser. Install the app on your phone to enable them.</p>
        ) : permission === 'denied' ? (
      ...
      <div className="border-t border-charcoal/8 dark:border-white/8 pt-4">
        <p className="text-sm font-medium text-charcoal dark:text-white mb-1">Notification Types</p>
        ...
        {prefsLoading ? (
          <p className="text-xs text-charcoal/35 dark:text-white/30 italic py-3">Loading preferences…</p>
        ) : (
          <div className="divide-y divide-charcoal/8 dark:divide-white/8">
      ...
      {/* Weekly email report */}
      <div className="border-t border-charcoal/8 dark:border-white/8 pt-4">
        <p className="text-sm font-medium text-charcoal dark:text-white mb-1">Weekly Report</p>
        <p className="text-xs text-charcoal/40 dark:text-white/35 mb-3">
          Send a summary report to <span className="font-medium text-charcoal/60 dark:text-white/50">{settings.manager_email || 'your manager email'}</span> covering hours, temp checks, cleaning and waste for the past 7 days.
        </p>
