...
export default function CleaningExportModal({ open, onClose }) {
  ...
  const handleExport = async () => {
    ...
    for (const t of neverDone) {
      rows.push([t.title, capitalize(t.frequency), departmentLabel(t), 'NOT COMPLETED', '', ''])
    }
    ...
    buildPdfReport({
      ...
      columns: ['Task', 'Frequency', 'Department', 'Completed By', 'Date & Time', 'Notes'],
      rows,
