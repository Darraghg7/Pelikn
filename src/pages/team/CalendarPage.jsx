...
function StaffLeaveBar({ year, month, staffLeave }) {
  ...
  return (
    <div>
      <div className="font-mono text-[11px] text-charcoal/30 dark:text-white/30 uppercase tracking-[0.08em] font-semibold mb-[9px]">Staff leave this month</div>
        ...
        {active.map(sl => {
          ...
          return (
            <div
              ...
              className="inline-flex items-center gap-[7px] py-1.5 pr-3 pl-2 rounded-full bg-white dark:bg-paperDark border-[1.5px] border-charcoal/10 dark:border-white/10"
            >
              <span className="w-6 h-6 rounded-[7px] bg-charcoal/6 dark:bg-white/8 flex items-center justify-center font-mono text-[11px] font-bold text-charcoal/50 dark:text-white/40">
                {sl.name.split(' ').map(w => w[0]).join('')}
              </span>
              <div>
                <div className="text-[12.5px] font-semibold text-charcoal dark:text-white leading-none">{sl.name.split(' ')[0]}</div>
                <div className="font-mono text-[11px] text-charcoal/30 dark:text-white/30 mt-[1px]">{label}</div>
              </div>
            </div>
          )
        })}
