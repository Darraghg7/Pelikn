...
export const TODAY_ITEM_REGISTRY = {
  ...
  opening_checks: {
    ...
    description: 'Daily opening completion',
  ...
  closing_checks: {
    ...
    description: 'Daily closing completion',
    feature: 'opening_closing',
