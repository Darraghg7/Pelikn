-- Rollback for 133_fridge_reminder_london_time.sql.
-- Restores 047's function exactly: the reminder goes back to comparing
-- fridge_check_time against UTC (an hour late during BST).
